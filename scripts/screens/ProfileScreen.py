...
class ProfileScreen(Screens):
        ...
        # Dangerous Tab
            ...
            if event.ui_element == self.kill_cat_button:
                ...
                if self.the_cat.dead:
                  ...
                  if self.the_cat.ID == game.clan.demon.ID and game.clan.followingur == True:
                            game.clan.followingur = False

                  elif self.the_cat.ID == game.clan.instructor.ID and not game.clan.followingur:
                       game.clan.followingur = True
    ...
    def build_profile(self):
        ...
        if is_sc_instructor:
            ...
            if game.clan.followingur == True:
                self.the_cat.thought = "Hello. I will be walking alongside the cats of " + game.clan.name + "Colony."
            else:
                self.the_cat.thought = "Misses watching over " + game.clan.name + "Clan"

        if is_df_instructor:
            if game.clan.followingur == True:
                self.the_cat.thought = "Wants to drag the cats of " + game.clan.name + "Colony into the Dark Forest"
                self.the_cat.df
            else:
